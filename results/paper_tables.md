# Paper tables — OCTMNIST, 3 seeds, last round (mean±std)
...
|---|---|---|---|
| FedAvg | 0.645 ± 0.065 | 0.935 ± 0.035 | 0.342 ± 0.076 |
...
| Method | Accuracy | Jain index | Worst-client acc |
|---|---|---|---|
| FedAvg | 0.448 ± 0.055 | 0.864 ± 0.007 | 0.119 ± 0.042 |
| FedDyn | 0.530 ± 0.086 | 0.906 ± 0.039 | 0.232 ± 0.115 |
| Proposed | 0.518 ± 0.042 | 0.904 ± 0.029 | 0.215 ± 0.078 |
